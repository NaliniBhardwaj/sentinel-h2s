"""Runtime feature extraction — schema must match sentinel/ml/feature_extraction.py."""
...
from app.ml.badge_layout import BASELINE_STRIP_LAB, REF_PATCH_RECTS, STRIP_RECT
from app.ml.preprocessing import delta_e_cie76, roi_bgr
